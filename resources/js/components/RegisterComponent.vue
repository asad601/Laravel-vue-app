...
<script>
    ...
    computed:{
      ...
      checkEmail(){
        if (/.+@.+\..+/.test(this.email)){
          axios.post('http:/laravue/public/api/email/verify', {'email': this.email})
          .then(res => {
        ...
        axios.interceptors.response.use( (response) => {
         ...
         axios.post('http:/laravue/public/api/users', {'name': this.name, 'email': this.email, 'password': this.password, 'rpassword': this.rpassword})
          .then(res =>  {
