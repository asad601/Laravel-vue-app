  ...
  export default {
    ...
    watch: {
      ...
      options:{
        ...
        axios.get(`http:/laravue/public/api/roles`,{params:{'page':e.page, 'per_page':e.itemsPerPage, 'sort_by': sortBy, 'order_by': orderBy}})
          .then(res => {
    ...
    methods: {
      ...
      deleteAll(){
        ...
        if(decide){
             axios.post('http:/laravue/public/api/roles/delete', {'roles': this.selected})
            .then(res => {
      ...
      searchIt(e){
        if(e.length > 3){
          axios.get(`http:/laravue/public/api/roles/${e}`)
              .then(res => this.roles = res.data.roles)
              .catch(err => console.dir(err.response))
        }
        if(e.length<=0){
          axios.get(`http:/laravue/public/api/roles`)
              .then(res => this.roles = res.data.roles)
              .catch(err => console.dir(err.response))
        }
      },
      ...
      deleteItem (item) {
        ...
        if(decide){
             axios.delete('http:/laravue/public/api/roles/'+item.id)
            .then(res => {
      ...
      save () {
        ...
        if (this.editedIndex > -1) {
          ...
          axios.put('http:/laravue/public/api/roles/'+this.editedItem.id, {'name': this.editedItem.name})
          .then(res => {
          ...
          // Object.assign(this.roles[this.editedIndex], this.editedItem)
           ...
           axios.post('http:/laravue/public/api/roles',{'name': this.editedItem.name})
          .then(res =>  {
